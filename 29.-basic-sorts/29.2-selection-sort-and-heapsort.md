...
You can see a demo of the sorting algorithm [here](https://joshh.ug/61b/sorts/selection_sort/index.html).
...
You can see a demo of this algorithm [here](https://joshh.ug/61b/sorts/heap_sort/index.html).
